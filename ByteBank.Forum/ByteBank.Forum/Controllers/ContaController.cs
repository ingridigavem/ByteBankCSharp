...
namespace ByteBank.Forum.Controllers {
    public class ContaController : Controller {
        ...
        private async Task EnviarEmailDeConfirmacaoAsync(UsuarioAplicacao usuario) {
            ...
            await UserManager.SendEmailAsync(usuario.Id, "Fórum ByteBank - Confirmação de Email", $"Bem vindo ao fórum ByteBank, clique aqui {linkDeCallback} para confirmar seu email!");
        }
